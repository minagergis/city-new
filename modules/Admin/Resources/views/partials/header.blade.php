...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="{{asset('public/assets/admin/pages/img/favicon.ico')}}" />
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    ...
                    {{--<h2>8 Digital CMS</h2>--}}
                         <img style="width: 100%;margin: 0;" src="{{asset('public/assets/admin/pages/img/logo.png')}}" width="150px" alt="logo" class="logo-default" />  </a>
