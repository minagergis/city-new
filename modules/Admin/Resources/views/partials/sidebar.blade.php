                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item  @if(\Request::get('post_type') == 'Magazine' or \Request::get('post_type') == 'Events' ) start active open @endif">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  @if(Request::route()->getName() == 'admin.posts.get' && \Request::get('post_type') == 'Magazine' ) start active open @endif">
                                    <a href="{{ route('admin.posts.get','post_type=Magazine') }}" class="nav-link ">
                                        <span class="title">All Magazines</span>
                                    </a>
                                </li>
