...
@section('content')
    ...
    <div id="slide-window-home">
        ...
        <ol id="slides" start="1">
            ...
            <li class="main-slide color-0 alive" style="background-image:url({{ asset('public/assets/site') }}/images/pic.jpg);">
            ...
            <li class="main-slide color-1" style="background-image:url({{ asset('public/assets/site') }}/images/pic2.jpg);">
                <div class="static-caption">
                    <span>. . . Creating Living</br> landmarks</span>
                </div>
            </li>

            <li class="main-slide color-2" style="background-image:url({{ asset('public/assets/site') }}/images/pic3.jpg);">
                <div class="static-caption">
                    <span>. . . Creating Living</br> landmarks</span>
                </div>
            </li>

            <li class="main-slide color-3" style="background-image:url({{ asset('public/assets/site') }}/images/pic4.jpg);">
                <div class="static-caption">
                    <span>. . . Creating Living</br> landmarks</span>
                </div>
            </li>

            <li class="main-slide color-4" style="background-image:url({{ asset('public/assets/site') }}/images/pic5.jpg);">
                <div class="static-caption">
                    <span>. . . Creating Living</br> landmarks</span>
                </div>
            </li>

            <li class="main-slide color-5" style="background-image:url({{ asset('public/assets/site') }}/images/pic6.jpg);">
                <div class="static-caption">
                    <span>. . . Creating Living</br> landmarks</span>
                </div>
            </li>
        ...
        <div class="slides-caption">
            <div class="container">
                ...
                <div class="caption-2"><span>Citystars katamyah</span></div>
                <div class="caption-3"><span>Citystars sharm el sheikh</span></div>
                <div class="caption-4"><span>Citystars el sahel</span></div>
                <div class="caption-5"><span>Citystars heliopolis</span></div>
                <div class="caption-6"><span>Citystars heliopolis</span></div>
            </div>
        </div>
